...
p.nominalBounds = new cjs.Rectangle(0,-14,893.9,72.9);
...
if (reversed == null) { reversed = false; }
	...
	// stageBackground
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(0,0,0,0)").ss(1,1,1,3,true).p("EhyDhH3MDkHAAAMAAACPvMjkHAAAg");
	this.shape_2.setTransform(720,450);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("EhyDBH4MAAAiPvMDkHAAAMAAACPvg");
	this.shape_3.setTransform(720,450);
